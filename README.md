...
BCH използва алгоритъм proof-of-work (PoW).
Proof of work е традиционният начин на валидиране на транзакции, при който копачите предоставят своята изчислителна мощ за решаване на сложни криптографски уравнения, като по този начин валидират транзакциите и се постига изключително високо ниво на сигурност
