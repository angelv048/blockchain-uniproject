...
![picture alt](https://cointelegraph.com/storage/uploads/view/a5e4bbc9a76ddcaeca08cf11300c1340.jpg)
	...
	* Много важно условие също така е дали ще 'копаме' сами или ще се присъедим към група копачи (mining pool).
		- При Груповият подход решаването на задачата е по-лесно и самата задача, също така е по-лесна, но крайното възнаграждение се разпределя между участниците,
		базирайки се на изчислителната мощност, с която са допринесли.
		- При самостоятелният подход, когато успееш да решиш задачата получаваш пълното възнаграждение от 12.5 BCH. Проблемът тук е, че ако не се разполага с 
		машина имаща изключително голама изчислителна мощ, която от своя страна изисква голям ресурс електро енергия, нямаме шанс да решим нито един блок.
